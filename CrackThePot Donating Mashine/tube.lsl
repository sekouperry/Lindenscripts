...
updateAmountText() {
    ...
    llSetText("Donate some money, and get half of the donation-POT if you crack it!\nYOU CAN GET AT LEAST L$ "+ (string)amountToWin+"!!\nYOU WILL DEFINITELY GET A COOL T-SHIRT!!\nCurrent POT is L$ "+ (string)currentPotSize + "\nOnly L$ " + (string)amountUntilCrack + " until crack.", <1,1,1>, 1.0);
}
